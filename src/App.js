  ...
  render(){
    return (
      <div className="wrapper clearfix">
        ...
        <button className="btn-new" onClick={this.btnNew}><i className="ion-ios-plus-outline"></i>New game</button>
        <button className="btn-roll" onClick={this.btnRoll}><i className="ion-ios-loop"></i>Roll dice</button>
        <button className="btn-hold" onClick={this.btnHold}><i className="ion-ios-download-outline"></i>Hold</button>
